...
; Generated by johndoe on 23.12.2016 (UTC)
;
[Setup]
AppID={{d611b541-0491-46e8-86ce-130a0ac02221}
AppName=ASCOM ESPTelescope Telescope Driver
AppVerName=ASCOM ESPTelescope Telescope Driver 0.0.1
AppVersion=0.0.1
AppPublisher=johndoe <johndoe8967@gmx.at>
AppPublisherURL=mailto:johndoe8967@gmx.at
...
OutputDir="."
OutputBaseFilename="ESPTelescope Setup"
Compression=lzma
...
UninstallFilesDir="{cf}\ASCOM\Uninstall\Telescope\ESPTelescope"

[Languages]
Name: "english"; MessagesFile: "compiler:Default.isl"

[Dirs]
Name: "{cf}\ASCOM\Uninstall\Telescope\ESPTelescope"
; TODO: Add subfolders below {app} as needed (e.g. Name: "{app}\MyFolder")

[Files]
; regserver flag only if native COM, not .NET
Source: "C:\Users\gp\Documents\Visual Studio 2015\Projects\Astro\driver\bin\debug\ASCOM.funky.Telescope.dll"; DestDir: "{app}" ;AfterInstall: RegASCOM(); Flags: regserver
; Require a read-me HTML to appear after installation, maybe driver's Help doc
Source: "C:\Users\gp\Documents\Visual Studio 2015\Projects\Astro\driver\ReadMe.htm"; DestDir: "{app}"; Flags: isreadme
...
begin
   ...
   P.Register('ESPTelescope.Telescope', 'Ascom.funky.Telescope');
end;
...
begin
   ...
   begin
     P := CreateOleObject('ASCOM.Utilities.Profile');
     P.DeviceType := 'Telescope';
     P.Unregister('ESPTelescope.Telescope');
  end;
end;
